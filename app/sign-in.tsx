  ...
  return (
    <SafeAreaView className="bg-white h-full">
      <ScrollView contentContainerClassName='h-full'>
        ...
        <Text className='text-base text-center uppercase font-rubik text-black-200'>Welcome to rayState</Text>
        <Text className='text-3xl font-rubik-bold text-black-300 text-center mt-2'>Let&apos;s get you closer to {"\n"}
          <Text className='text-primary-300'>Your Ideal Home</Text>
        </Text>
        <Text className='text-lg font-rubik text-black-200 text-center mt-12'>Login to RayState with Google</Text>
